...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-xl text-sm font-semibold ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default:
          "bg-neon text-black hover:bg-neon-400 hover:shadow-neon active:scale-95",
        destructive:
          "bg-destructive text-destructive-foreground hover:bg-destructive/90",
        outline:
          "border-2 border-neon bg-transparent text-neon hover:bg-neon/10 hover:shadow-neon",
        secondary:
          "bg-dark-50 text-white hover:bg-dark-50/80 border border-white/10",
        ghost: "hover:bg-white/5 hover:text-neon",
